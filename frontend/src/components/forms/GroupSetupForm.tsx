  ...
  const updateBasicInfo = (field: keyof GroupRentalInfo, value: any) => {
    ...
    if (field === 'clients') {
      ...
      setFormData(prev => {
        ...
        const isAutoGenerated = currentName.startsWith('Groupe de') || currentName === '' ||
                               (clients.length === 1 && currentName === clients[0]?.nom);

        return {
          ...prev,
          [field]: value,
          // Ne regénérer que si le nom actuel semble auto-généré
