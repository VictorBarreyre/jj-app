                ...
                return (
                  <div className="pt-3 border-t border-gray-300 mt-3">
                    ...
                    <div className="space-y-4 pb-4">
                      {order.groupDetails.participants.map((participant, index) => (
                    <div key={index} className="bg-white rounded-lg p-3 pb-4 text-left border border-gray-200">
              ...
              // Pour les commandes individuelles, créer un participant virtuel
                ...
                return (
                  <div className="pt-3 border-t border-gray-300 mt-3">
                    ...
                    <div className="space-y-4 pb-4">
                      <div className="bg-white rounded-lg p-3 pb-4 text-left border border-gray-200">
                        <div className="flex items-center justify-between mb-2">
                          <div className="font-semibold text-gray-800 text-left">
