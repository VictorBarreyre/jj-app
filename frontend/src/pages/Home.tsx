        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="flex justify-between items-start p-6 sm:p-8 border-b border-gray-200">
            <div className="text-left flex-1">
              <h1 className="text-lg sm:text-2xl font-bold text-gray-900 leading-tight text-left">Gestion des commandes</h1>
              <p className="text-gray-600 text-sm sm:text-sm mt-1 leading-normal sm:leading-relaxed">Consultez, modifiez et gérez toutes vos commandes de cérémonie</p>
            </div>
            <div className="ml-4">
              <Button 
                onClick={onCreateNew}
